<?php
    ...
    AND 
        products.product_id = orders_product.product_id 
    AND
            ...
            <div class="card-body">
                <div id="invoice">
                    <div class="toolbar hidden-print">
                        <div class="text-end">
                            <button type="button" onclick="window.print()" class="btn btn-info" style="color: white">
                            <svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-printer" viewBox="0 0 16 16">
                            ...
                            <a href="./dashboard.php" class="btn btn-outline-info">
                                <svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-return-left" viewBox="0 0 16 16">
                            ...
                            <header>
                                <div class="row">
                                    ...
                                    <div class="col company-details">
                                        <h2 class="name">
                                            <p target="_blank" href="javascript:;">
                                                Market management
                                            </p>
                                        </h2>
                                        <div>795 Godfrey Street, OR 97301, US</div>
                                        <div>metromarket.ceo@metromarket.com</div>
                                    </div>
                                </div>
                            </header>
                            <main>
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr style="text-align:center">
                                            ...
                                            <td class="total text-left"><?php echo $total_per_item ?> $ </td>
                                        </tr>
                                        <?php $Sr++; } ?>
                                    </tbody>
                                    <tfoot>
                                        ...
                                        <tr>
                                            ...
                                            <td> <?php echo $total; $tax = $total * 0.05?></td>
                                        </tr>
